    ...
    public class RemoteBoxHelper
    {
        ...
        public Dictionary<string, string> OpenRemoteBox(string serialNumber, string orderNo, string warehouseIndexs,byte type=0x01)
        {
            ...
            try
            {
                ...
                Log.WriteLog("类：RemoteBoxHelper", "方法：OpenRemoteBox", "orderNo：" + orderNo);
                ...
                Log.WriteLog("类：RemoteBoxHelper", "方法：OpenRemoteBox", "开箱命令：" + commandStr);
            ...
            {
                Log.WriteLog("类：RemoteBoxHelper", "方法：OpenRemoteBox", "异常信息：" + ex.Message+";异常位置:"+ex.StackTrace);
            }
