...
namespace tdx.database
{
    ...
    { 
        ...
        private void myInsert(string _Mvip_name, decimal _Mvip_price, decimal _Mvip_total, string _Mvip_des) // , int _cityID
        {
            try
            {
                string sql = "insert into B2C_memvip (Mvip_name,Mvip_price,Mvip_total,Mvip_des)" + //,cityID
                    " values (@Mvip_name,@Mvip_price,@Mvip_total,@Mvip_des)"; //,@cityID
                SqlParameter[] paras = new SqlParameter[] { 
                    ...
                    new SqlParameter("@Mvip_des", _Mvip_des)}; //, new SqlParameter("@cityID", _cityID)
        ...
        private void myUpdate(int _Mvip_id, string _Mvip_name, decimal _Mvip_price, decimal _Mvip_total, string _Mvip_des) //, int _cityID
        {
            try
            {
                string sql = "update B2C_memvip set Mvip_name=@Mvip_name,Mvip_price=@Mvip_price,Mvip_total=@Mvip_total,Mvip_des=@Mvip_des where Mvip_id=" + _Mvip_id; //,cityID=@cityID
                SqlParameter[] paras = new SqlParameter[] { 
                    new SqlParameter("@Mvip_name", _Mvip_name), 
                    new SqlParameter("@Mvip_price", _Mvip_price),
                    new SqlParameter("@Mvip_total", _Mvip_total),
