...
namespace tdx.database
{
    public class B2C_goods_S
    {
        ...
        private void myInsert(string _cno, string _s_name, int _s_flag, int _s_isPhoto, int _s_sort, int _s_isActive, int _s_isDel, int _s_isWeb, int _s_isSearch)//, int _cityid
        {
            ...
            try
            {//                                                                                                          ,cityid                                                                               ,@cityid
                string sql = "insert into B2C_goods_S (cno,s_name,s_flag,s_isPhoto,s_sort,s_isActive,s_isDel,s_isWeb,s_isSearch) values (@cno,@s_name,@s_flag,@s_isPhoto,@s_sort,@s_isActive,@s_isDel,@s_isWeb,@s_isSearch)";
                SqlParameter[] paras = new SqlParameter[] { 
                    ...
                    new SqlParameter("@s_isSearch", _s_isSearch)};//,new SqlParameter("@cityid", _cityid)
