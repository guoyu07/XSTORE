...
namespace tdx.database
{
    public class B2C_mem_law
    {
        ...
        public void Update()
        {
            if (id == 0)
            {
                this.myInsert(cno, mID, gtitle, gcontent, ggif, g_sort, g_hits, regtime, m_nation, m_xueli, m_zhuanye, m_byyx, m_bysj, m_sfks_date, m_zyzs_date, m_zyzs_num, m_ID_num, gaddr, g_chufen, g_jiaoda, g_sqyj, r_msg, rtime, gname, gsex, gtel, gqq, gbirth);//, cityID
            }
            else
            {
                this.myUpdate(id, cno, mID, gtitle, gcontent, ggif, g_sort, g_hits, regtime, m_nation, m_xueli, m_zhuanye, m_byyx, m_bysj, m_sfks_date, m_zyzs_date, m_zyzs_num, m_ID_num, gaddr, g_chufen, g_jiaoda, g_sqyj, r_msg, rtime, gname, gsex, gtel, gqq, gbirth);//, cityID
            }
        }
        public void Update2()
        {
            if (id == 0)
            {
                this.myInsert2(cno, mID, gtitle, gcontent, ggif, g_sort, g_hits, regtime, m_nation, m_xueli, m_zhuanye, m_byyx, m_bysj, m_sfks_date, m_zyzs_date, m_zyzs_num, m_ID_num, gaddr, g_chufen, g_jiaoda, g_sqyj, r_msg, rtime, gname, gsex, gtel, gqq, gbirth);//, cityID
            }
            else
            {
                this.myUpdate2(id, cno, mID, gtitle, gcontent, ggif, g_sort, g_hits, regtime, m_nation, m_xueli, m_zhuanye, m_byyx, m_bysj, m_sfks_date, m_zyzs_date, m_zyzs_num, m_ID_num, gaddr, g_chufen, g_jiaoda, g_sqyj, r_msg, rtime, gname, gsex, gtel, gqq, gbirth);//, cityID
            }
        }
        /// <summary>
        /// 添加方法
