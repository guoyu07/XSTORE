...
namespace tdx.database
{
    public class Wx_action
    {
        ...
        private void myInsertMethod(int _typeid, string _ac_title, string _ac_des, string _ac_dj_info, string _ac_end_title, string _ac_jp_one, DateTime _ac_bdate, DateTime _ac_edate, string _ac_jp_two, string _ac_jp_three, string _ac_b_gif, string _ac_zj_info, string _ac_end_des, string _ac_e_gif, string _ac_cf_info, int _ac_totlenum, int _ac_men_num, int _ac_jp_one_num, int _ac_jp_two_num, int _ac_jp_three_num, int _hits, int _views)//int _wid, 
        {
            ...
            //}
            string sql = "insert into Wx_action (typeid,ac_title,ac_des,ac_dj_info,ac_end_title,ac_jp_one,ac_bdate,ac_edate,ac_jp_two,ac_jp_three,ac_b_gif,ac_zj_info,ac_end_des,ac_e_gif,ac_cf_info,ac_totlenum,ac_men_num,ac_jp_one_num,ac_jp_two_num,ac_jp_three_num,hits,views)"; //wid,
            sql += "values (@typeid,@ac_title,@ac_des,@ac_dj_info,@ac_end_title,@ac_jp_one,@ac_bdate,@ac_edate,@ac_jp_two,@ac_jp_three,@ac_b_gif,@ac_zj_info,@ac_end_des,@ac_e_gif,@ac_cf_info,@ac_totlenum,@ac_men_num,@ac_jp_one_num,@ac_jp_two_num,@ac_jp_three_num,@hits,@views)"; //@wid,
        ...
        {
            string sql = "update Wx_action set typeid=@typeid,ac_title=@ac_title,ac_des=@ac_des,ac_dj_info=@ac_dj_info,ac_end_title=@ac_end_title,ac_jp_one=@ac_jp_one,ac_bdate=@ac_bdate,ac_edate=@ac_edate,ac_jp_two=@ac_jp_two,ac_jp_three=@ac_jp_three,ac_b_gif=@ac_b_gif,ac_zj_info=@ac_zj_info,ac_end_des=@ac_end_des,ac_e_gif=@ac_e_gif,ac_cf_info=@ac_cf_info,ac_totlenum=@ac_totlenum,ac_men_num=@ac_men_num,ac_jp_one_num=@ac_jp_one_num,ac_jp_two_num=@ac_jp_two_num,ac_jp_three_num=@ac_jp_three_num,hits=@hits,views=@views where id=@id";//wid=@wid,
            SqlParameter[] paras = new SqlParameter[] { 
                    new SqlParameter("@typeid", _typeid), 
                    new SqlParameter("@ac_title",_ac_title ),
                    new SqlParameter("@ac_des", _ac_des),
        ...
        public static DataTable GetList(string _dzd, string _sql)
        {
            ...
            try
            {
                dt = comfun.GetDataTableBySQL("select " + _dzd + " from Wx_action " + (_sql.Length > 0 ? "where " + _sql : _sql) + "");
            }
            catch (Exception ex)
            {
                throw ex;
