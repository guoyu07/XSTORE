...
namespace tdx.database
{
    public class B2C_Mem_Mail
    {
        ...
        private void myInsert(int _mid, string _n_title, string _n_msg, string n_target_, int _n_isRead, int _n_isReply, int _n_isdel) // , int _cityID
        {
            try
            {
                string sql = "insert into B2C_Mem_Mail (mid,n_title,n_msg,n_target,n_isRead,n_isReply,n_isdel)" + //,cityID
                    " values (@mid,@n_title,@n_msg,@n_target,@n_isRead,@n_isReply,@n_isdel)"; //,@cityID
                SqlParameter[] paras = new SqlParameter[] { 
                    ...
                    new SqlParameter("@n_isdel", _n_isdel)}; //,new SqlParameter("@cityID", _cityID)
        ...
        private void myUpdate(int _id, int _mid, string _n_title, string _n_msg, string n_target_, int _n_isRead, int _n_isReply, int _n_isdel) // , int _cityID
        {
            try
            {
                string sql = "update B2C_Mem_Mail set mid=@mid,n_title=@n_title,n_msg=@n_msg,n_target=@n_target,n_isRead=@n_isRead,n_isReply=@n_isReply,n_isdel=@n_isdel where id=" + _id; // ,cityID=@cityID
                SqlParameter[] paras = new SqlParameter[] { 
                    new SqlParameter("@mid", _mid), 
                    new SqlParameter("@n_title", _n_title), 
                    new SqlParameter("@n_msg", _n_msg),
