...
namespace tdx.database
{
    public class B2C_Goods
    {
        ...
        //public int cityid = Convert.ToInt32(System.Web.HttpContext.Current.Session["wID"].ToString());   //城市ID，暂不处理
        ...
        {//                                                             and cityid=" +  cityid.ToString() + "
            ...
            if (id == 0)
            {
                ...
                {//                                                       and cityid=" + cityid.ToString() + "                             and cityID=" + cityid.ToString()
        ...
        public void Update()
        {
            if (id == 0)
            {
                this.myInsert(cno, bno, g_no, g_txm, g_name, g_unit, g_gif, g_isURL, g_URL, g_sort, g_des, g_price_B, g_price_S, g_price_M, g_cent, g_lowN, g_flag, g_filename, g_title, g_key, g_description, g_isactive, g_isdel, g_sym, g_wdate, regtime, g_gif2, g_buytype, g_xuni);//, cityid
            }
            else
            {
