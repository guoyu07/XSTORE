...
namespace tdx.database
{
    public class B2C_logs
    {
        public static void MyInsert(string _logs)
        {
            ...
            string queryString = " INSERT INTO B2C_logs (Lmsg,Luname,Lip)";
        ...
        public static int delete(string _ids)
        {
            ...
            string sql = "delete from B2C_logs where id in (" + _ids + ")";
            try
            {
        ...
        public static DataTable GetList(int currentpage, string _dzd, string _sql)
        {
            ...
            try
            {
                dt = comfun.GetDataTableBySQL("select " + _dzd + " from B2C_logs where " + _sql + " order by id desc");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static DataTable GetList(string _dzd, string _sql)
        {
            ...
            try
            {
                dt = comfun.GetDataTableBySQL("select " + _dzd + " from B2C_logs where " + _sql + "");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static DataTable GetList()
        {
            ...
            try
            {
                dt = comfun.GetDataTableBySQL("select * from B2C_logs order id desc");
            }
            catch (Exception ex)
            {
                throw ex;
