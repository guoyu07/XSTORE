<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Merchant.aspx.cs" Inherits="Tuan.Merchant" %>
...
<div class="bott">
	<div class="menu_b">
		<ul>
			<li class="on"><a href="Homepage.aspx?id=<%=id %>"><div class="home"><b></b></div><div>首页</div></a></li>
