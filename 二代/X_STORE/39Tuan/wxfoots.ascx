<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wxfoots.ascx.cs" Inherits="Wx_NewWeb.Message.wxfoots" %>
<div class="i_copyright">
    ...
    <div class="shchkj">
       技术支持：
       <a href="http://www.tdx.cn/appv/index.aspx?WWX=gh_4891e4667327" target="_blank">红豆万花城</a>
    </div>
</div>
