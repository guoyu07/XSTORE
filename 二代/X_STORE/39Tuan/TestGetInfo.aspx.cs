...
namespace Tuan
{
    public partial class TestGetInfo : System.Web.UI.Page
    { 
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Cookies["openid"] != null && Request.Cookies["openid"].Value != "" && Request.Cookies["refresh_token"] != null && Request.Cookies["refresh_token"].Value != "")
            {
                ...
                try
                {
                    ...
                    if (Request["back_url"] != null)
                    {
                        Response.Redirect("" + Request["back_url"].ToString() + "&openid=" + j2["openid"].ToString() + "&name=" + j3["nickname"].ToString() + "&sex=" + (j3["sex"].ToString().Equals("1") ? "男" : "女") + "&headimg=" + j3["headimgurl"].ToString() + "&unionid=" + j3["unionid"].ToString() + "");
                    }
                    else
                    {
                    }
            ...
            else
            {
                if (Request["code"] != null)
                {
                    ...
                    if (Request["back_url"] != null)
                    {
                        Response.Redirect("" + Request["back_url"].ToString() + "&openid=" + j["openid"].ToString() + "&name=" + j3["nickname"].ToString() + "&sex=" + (j3["sex"].ToString().Equals("1") ? "男" : "女") + "&headimg=" + j3["headimgurl"].ToString() + "&unionid=" + j3["unionid"].ToString() + "");
                    }
                    else
                    {
                    }
