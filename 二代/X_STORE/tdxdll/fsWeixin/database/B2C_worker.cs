...
namespace tdx.database
{
    public class B2C_worker
    {
        ...
        //{
        //    string _sql = "select *,(select mvip_name from b2c_memvip where b2c_memvip.mvip_id=b2c_worker.m_vip) as Mvipname";
        //    _sql += ",(select top 1 wx_name from wx_mp where wid=b2c_worker.id) as wx_name2";
        //    _sql += ",(select top 1 wx_nichen from wx_mp where wid=b2c_worker.id) as wx_nichen2";
        //    _sql += ",(select top 1 wx_2wm from wx_mp where wid=b2c_worker.id) as wx_2wm2";
        //    _sql += ",(select top 1 wx_ID from wx_mp where wid=b2c_worker.id) as wx_ID2";
        //    _sql += ",(select top 1 wx_DID from wx_mp where wid=b2c_worker.id) as wx_DID2";
        //    _sql += ",(select top 1 wx_Dpsw from wx_mp where wid=b2c_worker.id) as wx_Dpsw2";
        //    _sql += " from B2C_worker where 1=1";
        //    if (this.id != 0)
        //    {
        //        _sql += " and id=" + this.id;
        //    }
        ...
        //        M_name = Convert.IsDBNull(dr["M_name"]) ? "" : Convert.ToString(dr["M_name"]);
        ...
        //private void myInsertMethod(string _M_name, string _M_psw, string _M_question, string _M_answer, string _M_company, string _M_tel, string _M_mobile, string _M_email, string _M_url, string _M_QQ, string _wx_name, string _wx_2wm, string _wx_ID, int _wx_theme, int _wx_theme2, int _wx_theme3,int _wx_theme4, int _M_vip, int _cityID, string _M_nichen, string _M_DID, string _M_Dpsw, DateTime _M_Bdate, DateTime _M_Edate, DateTime _M_Udate, int _wx_FirstIsGif, string _wx_GNtheme, string _hy_no, string _area_no, string _m_map,int _M_isactive=1)
        //{
        ...
        //    }
        //    string sql = "insert into B2C_worker (M_name,M_psw,M_question,M_answer,M_company,M_tel,M_mobile,M_email,M_url,M_QQ,wx_name,wx_2wm,wx_ID,wx_theme,wx_theme2,wx_theme3,wx_theme4,M_vip,cityID,wx_nichen,wx_DID,wx_Dpsw,M_Bdate,M_Edate,M_Udate,wx_FirstIsGif,wx_GNtheme,hy_no,area_no,M_isactive,M_map)";
        //    sql += "values (@M_name,@M_psw,@M_question,@M_answer,@M_company,@M_tel,@M_mobile,@M_email,@M_url,@M_QQ,@wx_name,@wx_2wm,@wx_ID,@wx_theme,@wx_theme2,@wx_theme3,@wx_theme4,@M_vip,@cityID,@wx_nichen,@wx_DID,@wx_Dpsw,@M_Bdate,@M_Edate,@M_Udate,@wx_FirstIsGif,@wx_GNtheme,@hy_no,@area_no,@M_isactive,@M_map)";
        ...
        //    }
        //}
        //private void myUpdateMethod(string _M_name, string _M_psw, string _M_question, string _M_answer, string _M_company, string _M_tel, string _M_mobile, string _M_email, string _M_url, string _M_QQ, string _wx_name, string _wx_2wm, string _wx_ID, int _wx_theme, int _wx_theme2, int _wx_theme3,int _wx_theme4, int _M_vip, int _cityID, int _id, string _M_nichen, string _M_DID, string _M_Dpsw, DateTime _M_Bdate, DateTime _M_Edate, DateTime _M_Udate, int _wx_FirstIsGif, string _wx_GNtheme, string _hy_no, string _area_no, int _M_lx, string _m_map, int _M_isactive = 1)
        //{
        //    string sql = "update B2C_worker set M_name=@M_name,M_psw=@M_psw,M_question=@M_question,M_answer=@M_answer,M_company=@M_company,M_tel=@M_tel,M_mobile=@M_mobile,M_email=@M_email,M_url=@M_url,M_QQ=@M_QQ,wx_name=@wx_name,wx_2wm=@wx_2wm,wx_ID=@wx_ID,wx_theme=@wx_theme,wx_theme2=@wx_theme2,wx_theme3=@wx_theme3,wx_theme4=@wx_theme4,M_vip=@M_vip,cityID=@cityID,wx_nichen=@wx_nichen,wx_DID=@wx_DID,wx_Dpsw=@wx_Dpsw,M_Bdate=@M_Bdate,M_Edate=@M_Edate,M_Udate=@M_Udate,wx_FirstIsGif=@wx_FirstIsGif,wx_GNtheme=@wxGNtheme,hy_no=@hy_no,area_no=@area_no,M_isactive=@M_isactive,M_lx=@M_lx,M_map=@M_map  where id=@id";
        //    SqlParameter[] paras = new SqlParameter[] { 
        //            new SqlParameter("@M_name", _M_name), 
