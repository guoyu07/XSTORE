...
namespace tdx.database
{
    public class B2C_laws
    {
        ...
        public void Update()
        {
            if (id == 0)
            {
                this.myInsert(cno,mID, shopID, gtitle, gcontent,ggif, g_hits, regtime,  cityID,gtel,dsrname,dfdsrname,cljgname,dsr_IDCard,dsr_frIDCard,dsr_yingye,ht_no ,gno,g_money,dsr_IDC_gif,dsr_fr_gif,ht_gif,dsr_yingye_gif,qID);
            }
            else
            {
                this.myUpdate(id, cno, mID, shopID, gtitle, gcontent, ggif, g_hits, regtime, cityID, gtel, dsrname, dfdsrname, cljgname, dsr_IDCard, dsr_frIDCard, dsr_yingye, ht_no, gno, g_money, dsr_IDC_gif, dsr_fr_gif, ht_gif, dsr_yingye_gif,qID);
            }
        }
        /// <summary>
        /// 添加方法
