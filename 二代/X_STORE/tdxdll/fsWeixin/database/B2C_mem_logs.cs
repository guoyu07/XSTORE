...
namespace tdx.database
{
    public class B2C_mem_logs
    {
        ...
        private void myInsert(string _log_action, string _log_IPs, string _log_tabs, string _log_rows, string _log_values, string _tag_tabs, string _tag_rows, string _tag_value, string _log_timezone, string _log_browser, string _log_width, int _cityID)
        {
            try
            {
                string sql = "insert into B2C_mem_logs (log_action,log_IPs,log_tabs,log_rows,log_values,tag_tabs,tag_rows,tag_value,log_timezone,log_browser,log_width,cityID) values (@log_action,@log_IPs,@log_tabs,@log_rows,@log_values,@tag_tabs,@tag_rows,@tag_value,@log_timezone,@log_browser,@log_width,@cityID)";
                SqlParameter[] paras = new SqlParameter[] { 
                    ...
                    new SqlParameter("@log_width", _log_width),
