    ...
    public class guotaotao
    {
        ...
        public string GetReMsg()
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0) //有内容可回复
                {
                    ...
                    string _pic = string.IsNullOrEmpty(dr["k_image"].ToString().Trim()) ? "http://lingang.creatrue.net" + dr3["a_adGif"].ToString().Trim() : dr["k_image"].ToString().Trim();
                    string _des = dr["k_answer"].ToString().Trim();
                    string _url = string.IsNullOrEmpty(dr["k_image"].ToString().Trim()) ? ("http://lingang.creatrue.net/showKeys.aspx?id=" + dr["id"].ToString().Trim() + "&") : (dr3["a_url"].ToString().Trim() + "?"); //" + dr5["wx_GNTheme"].ToString().Trim() + "
                            ...
                            foreach (DataRow dr4 in ds.Tables[0].Rows)
                            {
                                ...
                                if (!string.IsNullOrEmpty(dr4["k_url2"].ToString()))
                                {
                                    ...
                                    {//是一个内部地址
                                        ...
                                        {
                                            _url = "http://www.tdx.cn" + _url;
                                        }
                                        else //同级目录下的文档
                                        {
                                            _url = "http://www.tdx.cn/" + this._GNTheme + "/" + _url ;
                                        }
                                        _url +=  _url.IndexOf("?")!=-1 ? "&":"?";
                                        _url += "WWX=" + this._toUserName + "&WWV=" + this._FromUserName; 
        ...
        public string GetMenuHandle(RequestXML requestXML)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                string _pic = string.IsNullOrEmpty(dr["c_gif"].ToString().Trim()) ? ("http://lingang.creatrue.net" + dr2["a_adGif"].ToString().Trim()) : ("http://lingang.creatrue.net" + dr["c_gif"].ToString().Trim());
                string _des = dr["c_des"].ToString().Trim();
                ////////////////////////////////////////
                //string _url = string.IsNullOrEmpty(dr["c_url"].ToString().Trim()) ? (dr2["a_url"].ToString().Trim()) : ("http://lingang.creatrue.net/" + dr3["wx_GNTheme"].ToString().Trim() + "/" + dr["c_url"].ToString().Trim());
                ////////////////////////////// 修改相对链接地址
                string _url = string.IsNullOrEmpty(dr["c_url"].ToString().Trim()) ? (dr2["a_url"].ToString().Trim()) : (dr["c_url"].ToString().Trim().StartsWith("/") ? ("http://lingang.creatrue.net" + dr["c_url"].ToString().Trim()) : ("http://lingang.creatrue.net/" + dr["c_url"].ToString().Trim())); //dr3["wx_GNTheme"].ToString().Trim() + "/" +
