        ...
        this.each(function() {
            ...
            if (m >= u) {
                ...
                case "fold":
                    ...
                    break;
                case "top":
                    l.wrap('<div class="tempWrap" style="overflow:hidden; position:relative; height:' + c.width + 'px"></div>').css({
                        top: -(p * t) * C,
                        position: "relative",
                        padding: "0",
                        margin: "0"
                    ...
                    break;
                case "left":
                    l.wrap('<div class="tempWrap" style="overflow:hidden; position:relative; width:' + c.width + 'px"></div>').css({
                        width: m * D,
                        left: -(p * t) * D,
                        position: "relative",
                        overflow: "hidden",
