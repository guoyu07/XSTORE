...
{
    public partial class FerightList : System.Web.UI.Page
    {
        ...
        private void sousuo()
        {
            string sql = "select  a.id,b.name,convert(varchar(50),a.createtime,23) as createtime  from WP_FreightMain a left join (select  distinct name,mainid from WP_FreightMainD ) b on a.id=b.mainid  ";
