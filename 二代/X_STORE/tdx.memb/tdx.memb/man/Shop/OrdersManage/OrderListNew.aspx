...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderListNew.aspx.cs" Inherits="tdx.memb.man.Shop.OrdersManage.OrderListNew" %>
...
<head>
    ...
    <script type="text/javascript">
        function popupDiv(div_id, obj) {
            ...
            var windowWidth1 = document.body.clientWidth;
        ...
        function hideDiv(div_id, obj) {
            ...
            if (text == "确定") {
                ...
                $.ajax({
                    ...
                    data: { ordernum: orderNo, danhao: txtdanhao, gongsi: txtgongsi, ordertype: "WP" },
                    async: false,
                    success: function (data) {
                        if (data = "true") {
                            alert("操作成功!");
        ...
        function hideDivYun(div_id, obj) {
            ...
            if (text == "保存") {
                ...
                $.ajax({
                    ...
                    data: { ordernum: orderNo, yunfei: txtyunfei, yingfuold: txtyingfuold, yingfunew: txtyingfunew, ordertype: "WP", quanxian: txtquanxian },
                    async: false,
                    success: function (data) {
                        debugger;
                        console.log(data);
        ...
        //查看物流
        function look_wuliu(wuliu, danhao) {
            $.ajax({
                type: "post",
                datatype: "text",
                url: "look.ashx",
                data: { wuliu: wuliu, danhao: danhao },
                async: false,
                success: function (data) {
                    location.href = data;
                }
            ...
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li>&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn" OnClick="lbtn_Export_Click"><span>订单信息导出</span></asp:LinkButton></li>
                        <li>&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn" OnClick="lbtn_ExpsortSum_Click"><span>订单管理导出</span></asp:LinkButton></li>
