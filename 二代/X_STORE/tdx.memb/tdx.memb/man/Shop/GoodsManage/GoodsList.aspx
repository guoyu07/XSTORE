<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsList.aspx.cs" Inherits="tdx.memb.man.Shop.GoodsManage.GoodsList" EnableEventValidation="false" ViewStateEncryptionMode="Never" EnableViewStateMac="false" %>
...
<%--                        <li>&nbsp;&nbsp;<span style="font-size: 12px;">仓库</span>&nbsp;<asp:TextBox ID="txt_store" runat="server" CssClass="input" sucmsg=" " /></li>--%>
                ...
                <div class="rule-single-select">
                    <asp:DropDownList CssClass="input" ID="ddl_store" runat="server"
                ...
                <span style="font-size: 12px;">数量：<%=totalcount%></span>
            </div>
            ...
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li>
                            <asp:LinkButton ID="btn_设置分销率" runat="server" OnClick="btn_设置分销率_Click" CssClass="add"><i></i><span>设置分销率</span></asp:LinkButton></li>
                        <li>
...
<%--                        <td style="text-align: center;"><%#Eval("是否卖家承担运费").ToString()=="1"?"是":"否"%></td>--%>
                        ...
                        <%--                        <td style="text-align: center;"><a href="GoodsComment.aspx?spid=<%#Eval("商品id")%> &types=WP ">查看评论</a> </td>   --%>
                        <td style="text-align: center;"><a onclick="window.open('/shop/chanpin.aspx?gid=<%#Eval("商品id")%>&WHC=123', '', 'height=543,width=376,scrollbars=yes,status=yes');">预览</a> </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
        </table>
