<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsEdit.aspx.cs" Inherits="tdx.memb.man.Shop.GoodsManage.GoodsEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <%--         <dl>
                <dt>规格</dt>
                <dd>
                    <asp:TextBox ID="txt_guige" runat="server" placeholder="规格少于25个字" CssClass="input normal"></asp:TextBox>
                    <span class="Validform_checktip">*必填</span>
                </dd>
                <dt>重量(kg)</dt>
                <dd>
                    <asp:TextBox ID="txt_zhongliang" runat="server" CssClass="input normal"></asp:TextBox>
                    <span class="Validform_checktip">*必填</span>
                </dd>
                <dt>价格</dt>
                <dd>
                    <asp:TextBox ID="txt_benzhanjia" runat="server" CssClass="input   normal"></asp:TextBox>
                    <span class="Validform_checktip">*必填</span>
                </dd>
            </dl>--%>
            <dl>
