...
{
    public partial class advert_operate : System.Web.UI.Page
    {
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            if (result)
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(), "1", "alert('添加成功');location.href='advert_manage.aspx'", true);
            }
            else
            {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (result)
            {
                this.ClientScript.RegisterClientScriptBlock(this.GetType(), "1", "alert('修改成功');location.href='advert_manage.aspx'", true);
            }
            else
            {
