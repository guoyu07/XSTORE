<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advert_manage.aspx.cs" Inherits="tdx.memb.man.Shop.advert_manage" %>
...
<%--  </div>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td>
           <a href="advert_operate.aspx?ID=<%#Eval("id")%>&Act=Edit">修改</a>
