<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InStockAdd.aspx.cs" Inherits="tdx.memb.box.InStockAdd" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="rk_again" runat="server" /><%--是否是重新入库--%>
            ...
            <div class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <%--                            <li>&nbsp;&nbsp;<span style="font-size: 16px;">选择市</span>
        ...
        <div width=" 100%;">
                <asp:Label runat="server" Style="text-align: center; color: red; font-size: 18px; width: 100%">
                    *请先选择相应的库位,否则无法查看特定酒店所能出售的商品。此处入库的商品才能出库至房间*</asp:Label>
            </div>
        <telerik:RadAjaxPanel runat="server">
