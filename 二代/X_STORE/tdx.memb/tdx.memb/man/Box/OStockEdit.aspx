<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OStockEdit.aspx.cs" Inherits="tdx.memb.box.OStockEdit" %>
            ...
            <div class="toolbar-wrap">
                <div class="toolbar">
                    <div class="l-list">
                        <ul class="icon-list">
                            <li>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span style="font-size: 16px;">出库号：</span>&nbsp;
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                          ...
                          <%--  <li>&nbsp;&nbsp;<span style="font-size: 16px;">选择位置</span>
                                <asp:DropDownList CssClass="input" ID="ddl_wz" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_wz_SelectedIndexChanged"></asp:DropDownList>
                            </li>--%>
                        </ul>
                    </div>
                </div>
