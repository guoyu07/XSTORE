<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsSalesVolume.aspx.cs" Inherits="tdx.memb.man.ShoppingMall.OrdersManage.GoodsSalesVolume" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="text-align: center;">
                                ...
                                <%#GetName(Eval("商品id").ObjToStr()) %>
                            </td>
                            <td style="text-align: center;"><%#Eval("总量") %></td>
                            <td style="text-align: center;"><%#GetMoney(Eval("商品id").ObjToStr() )%></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
