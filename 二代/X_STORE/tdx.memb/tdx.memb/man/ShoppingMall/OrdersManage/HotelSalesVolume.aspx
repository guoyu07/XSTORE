<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelSalesVolume.aspx.cs" Inherits="tdx.memb.man.ShoppingMall.OrdersManage.HotelSalesVolume" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list" style="float: left;">
                        <li>&nbsp;&nbsp;<span style="font-size: 12px;">酒店名</span>&nbsp;<asp:TextBox ID="txt_goods_name" runat="server" CssClass="input" /></li>
            ...
            <table style="width: 100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                <tr>
                    <th style="width: 33%">酒店名</th>
                    <th style="width: 33%">销售总量</th>
                    <th style="width: 33%">销售总额</th>
                </tr>
