<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsSales.aspx.cs" Inherits="tdx.memb.man.ShoppingMall.GoodsManage.GoodsSales" %>
...
<%--                <th width="8%">选择</th>--%>
                ...
                <th width="6%">条形码<br />
                    品名</th>
                <th width="6%">类别</th>
                <th width="6%">单位<br/>规格</th>
                <th width="6%">重量</th>
                <th width="6%">市场价<br />本站价</th>
                <th width="6%">库存<br />限购数量</th>
                <th width="6%">上架时间<br />下架时间</th>
                <th width="6%">上架/下架</th>
                <th width="6%">分销率</th>
                <th width="6%">折扣率</th>
                <th width="6%">销量</th>
...
<%--                        <td style="text-align: center;">
                        ...
                        <td style="text-align: center;"><%#Eval("单位")%><br /> <%#Eval("规格")%></td>
                        ...
                        <td style="text-align: center;"><%#Eval("库存数量")%><br /><%#Eval("限购数量")%></td>
                        <td style="text-align: center;">
                            <dl>
                                <dt><%#Eval("上架时间") %></dt>
                                <dt><%#Eval("下架时间")%></dt>
