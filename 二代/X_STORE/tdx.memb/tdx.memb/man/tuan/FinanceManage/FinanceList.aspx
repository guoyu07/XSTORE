<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceList.aspx.cs" Inherits="tdx.memb.man.Tuan.FinanceManage.FinanceList" %>
            ...
            <asp:Repeater ID="Rp_UserInfo" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align: center;"><%#Eval("订单号")%></td>
                        
                        <td style="text-align: center;"><%#Eval("返利金额")%></td>
                         
                        <td style="text-align: center;"><%#Eval("返利时间").ToString().Substring(0,10)%> </td>
