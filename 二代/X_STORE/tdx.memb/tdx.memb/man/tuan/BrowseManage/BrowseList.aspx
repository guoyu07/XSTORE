<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrowseList.aspx.cs" Inherits="tdx.memb.man.Tuan.BrowseManage.BrowseList" %>
            ...
            <asp:Repeater ID="Rp_UserInfo" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align: center;"><%#Eval("浏览人openid")%></td>
                        <td style="text-align: center;"><%#Eval("分享人openid")%></td> 
                        <td style="text-align: center;"><%#Eval("订单编号")%></td> 
                        <td style="text-align: center;"><%#Eval("浏览时间").ToString().Substring(0,10)%> </td>
                        <td style="text-align: center;"><%#Eval("IP")%></td>
                        <td style="text-align: center;"><%#Eval("设备型号")%></td>
