<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OederStatus.aspx.cs" Inherits="tdx.memb.man.tuan.OrdersManage.OederStatus" %>
        ...
        <div class="m" id="orderinfo">
            ...
            <div class="total">
                <ul>
                    ...
                    <li><span>- 余额：</span>￥<%=余额 %></li><li><span>+ 运费：</span>￥<%=运费 %></li>
                </ul>
