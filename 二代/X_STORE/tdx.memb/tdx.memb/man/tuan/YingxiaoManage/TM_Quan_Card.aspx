<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TM_Quan_Card.aspx.cs" Inherits="tdx.memb.man.tuan.YingxiaoManage.TM_Quan_Card" %>
...
<%--                        <li><a class="add" href="TM_Quan_Add.aspx"><i></i><span>新增</span></a></li>--%>
                        ...
                        <li>
                            <asp:LinkButton ID="lbtn_Export" runat="server" CssClass="btn" OnClick="lbtn_Export_Click"><span>卡券导出</span></asp:LinkButton></li>
                    </ul>
                </div>
            </div>
        </div>
