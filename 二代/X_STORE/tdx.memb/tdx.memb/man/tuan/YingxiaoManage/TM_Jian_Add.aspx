<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TM_Jian_Add.aspx.cs" Inherits="tdx.memb.man.Tuan.YingxiaoManage.TM_Jian_Add" %>
...
<body>
    <form id="form1" runat="server">
        <div class="location">
            ...
            <i class="arrow"></i>
            <a href="tm_jian_List.aspx"><span>满减管理</span></a>
            <i class="arrow"></i>
            <span>新增申请</span>
        </div>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑满减</a></li>
                    </ul>
                </div>
            </div>
        </div>
