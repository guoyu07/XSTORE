...
{
    public partial class B2C_taocan_Add : workAuth
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    if (Request["id"] != null)
                    {
                        ...
                        {
                            comfun.ChuliException(exe, "man/Goods/B2C_taocan_Add.cs", Session["wID"].ToString());
                        }
                    }
                    else
                    {
                ...
                {
                    comfun.ChuliException(ex, "man/goods/B2C_taocan_Add.aspx.cs", Session["wID"].ToString());
                }
            }
        ...
        protected void btnSave_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string _g_des = comFunction.NoSt(des.Value);
                string _g_filename = comFunction.NoHTML(filename.Value);
                string _g_key = _key.Value;
                string _g_description = comFunction.NoSt(_description.Value);
            ...
            {
                comfun.ChuliException(ex, "man/goods/B2C_taocan_Add.cs", Session["wID"].ToString());
            }
        }
    }
}