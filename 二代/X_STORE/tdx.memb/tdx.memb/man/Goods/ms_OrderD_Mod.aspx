<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ms_OrderD_Mod.aspx.cs" Inherits="tdx.memb.man.Goods.ms_OrderD_Mod" %>
    ...
    <div class="nei_content" id="nei_content">
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtPrice" placeholder="秒杀商品价格" class="px" runat="server"
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtAmt" placeholder="秒杀商品单价" class="px" runat="server" id="txtAmt" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtCent" placeholder="商品赠送积分" class="px" runat="server"
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtAllAmt" placeholder="商品赠送总积分" class="px" runat="server"
                        id="txtAllAmt" />
