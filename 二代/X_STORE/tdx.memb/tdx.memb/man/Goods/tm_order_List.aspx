<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tm_order_List.aspx.cs" Inherits="tdx.memb.man.Goods.tm_order_List" %>
     ...
     <div class="greenRemind">
        ...
        <div class="nei_seach">
            订单编号：<input type="text" value="" name="ss_keyword" id="ss_keyword" runat="server" placeholder="请输入订单号查询"
                class="px2s" onclick="this.value='';" />
            &nbsp;<input id="txt_StartCPXG" runat="server" cssclass="edLine" readonly="readonly" onfocus="HS_setDate(this)" placeholder="请输入截止时间，缺省截止到当天"
                class="sousuo_px" type="text" />
            &nbsp;
            <input id="txt_StartCPXG_DATE" runat="server" cssclass="edLine" readonly="readonly" onfocus="HS_setDate(this)" placeholder="请输入起始时间，缺省从当月1号开始"
                class="sousuo_px" type="text" />
            &nbsp;
        ...
        <div class="tdh">
            <asp:Literal ID="lb_catelist" runat="server"> </asp:Literal></div>
        <div class="tdh">
            <div class="page">
