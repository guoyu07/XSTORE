...
{
    public partial class tm_Orders_Mod : workAuth
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request["ono"] != null)
                {
                    ...
                    tm_orders order = new tm_orders(_ono);
        ...
        protected void btnSave_ServerClick(object sender, EventArgs e)
        {
            ...
            string _od_des = txtRemarks.Value;//备注
            ...
            if (Request["ono"] != null) //修改
            {
                try
                {
                    ...
                    string _sql = "update tm_orders set o_amt=" + _o_amt + ",o_st_amt=" + _o_yf + ",o_allamt=" + _o_allamt + ",o_cent=" + _o_cent + ",o_des='" + _od_des.Replace("'", "") + "' where o_no='" + _ono + "'";
                    _sql += ";\r\n " + tm_orders.insertAddrSQL(_ono, _o_linker, "", _o_addr, _o_zip, _o_tel, _o_mobile, _o_SendDate, _od_des);
