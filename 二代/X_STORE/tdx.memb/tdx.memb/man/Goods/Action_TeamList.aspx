<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Action_TeamList.aspx.cs" Inherits="tdx.memb.man.Goods.Action_TeamList" %>
...
<body>
    ...
    <div class="nei_content">
       ...
       <div class="greenRemind">
        ...
        <div class="tdh">
            <asp:Literal ID="lb_prolist" runat="server"></asp:Literal></div>
    </div>
    </form>
</body>
</html>
