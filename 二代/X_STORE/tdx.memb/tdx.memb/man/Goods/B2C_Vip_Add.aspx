<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_Vip_Add.aspx.cs" Inherits="tdx.memb.man.Goods.B2C_Vip_Add" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Assembly="FredCK.FCKeditorV2" Namespace="FredCK.FCKeditorV2" TagPrefix="fckeditorv2" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>会员特权商品管理</title>
...
<body>
    ...
    <div class="nei_content" id="nei_content">
        ...
        <input type="hidden" name="rd_buytype" value="1" id="rd_buytype" runat="server" />
