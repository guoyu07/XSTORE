<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_taocan_Add.aspx.cs" Inherits="tdx.memb.man.Goods.B2C_taocan_Add" %>
...
<body>   
    ...
    <div class="nei_content" id="nei_content">
     <asp:Literal ID="ltHead" runat="server"></asp:Literal>
        ...
        <input type="hidden" name="g_cent" value="0" id="g_cent" runat="server" />
        <input type="hidden" name="lowN" value="0" id="lowN" runat="server" />
        <input type="hidden" name="rd_xn" value="0" id="rd_xn" runat="server" />
        <input type="hidden" name="rd_buytype" value="3" id="rd_buytype" runat="server" />
