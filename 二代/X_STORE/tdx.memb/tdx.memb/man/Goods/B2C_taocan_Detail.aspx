<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_taocan_Detail.aspx.cs" Inherits="tdx.memb.man.Goods.B2C_taocan_Detail" %>
...
<body>
    ...
    <h1>
        <strong>套餐产品 - 包含产品： <asp:Literal ID="lt_proTitle" runat="server" ></asp:Literal></strong></h1>
    <div class="nei_content">
      ...
      <div class="greenRemind">
        ...
        <div class="btn_container"> 
            <asp:Button ID="delBtn" runat="server" Text=" 删 除 " class="btnDelete" 
                OnClientClick="return confirm('确定删除吗？')" onclick="delBtn_Click" />
        </div>
        <div class="tdh">
        ...
        <div class="btn_container"> 
            <asp:Button ID="btnAdd" runat="server" Text=" 添加进套餐 " class="btnGray" 
                  onclick="btnAdd_Click" />
        </div>
        <div class="tdh">
            <asp:Literal ID="lb_catelist2" runat="server"> </asp:Literal> 
        </div>
        <!--center content end-->
    </div>
    </form>
