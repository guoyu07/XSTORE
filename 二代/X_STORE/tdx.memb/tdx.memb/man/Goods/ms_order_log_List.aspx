<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ms_order_log_List.aspx.cs" Inherits="tdx.memb.man.Goods.ms_order_log_List" %>
...
<body>
    ...
    <div class="nei_content">
        ...
        <table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
            <tr>
                <td width="20%" align="left" height="40" class='borderBottom'>
                    <asp:Label ID="lb_cateadd" runat="server"> </asp:Label>
                </td>
                <td width="80%" align="left" height="40" class='borderBottom'>
                    <asp:Button ID="delBtn" runat="server" Text="删除" class="btnGray" ForeColor="Red"
