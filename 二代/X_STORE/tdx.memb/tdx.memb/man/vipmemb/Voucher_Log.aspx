<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Voucher_Log.aspx.cs" Inherits="tdx.memb.man.vipmemb.Voucher_Log" %>
...
<body>
    ...
    <div id="nei_content" class="nei_content">
        ...
        <div class="nei_seach">
            <input type="text" id="sousuo_txt" runat="server" class="sousuo_px" placeholder="请填写用户名进行查询">
