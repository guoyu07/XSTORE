...
{
    public partial class Wallet : workAuth
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Session["wid"] != null)
                {
                    ...
                    string _sql = "*";
                    string _where = "wid=" + wid + " and isdel<>1 and category=2";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            result1 += " \r\n<td ><a href=\"" + "WalletEdit.aspx?id=" + dr["id"].ToString() + "\"><img width=\"20\" height=\"20\" src=\"/man/images4/Icon_xiugai.png\"></a></td>";
                            result1 += " \r\n </tr>";
                        }
                        result1 += " \r\n </tbody>";
                        result1 += " \r\n </table>";
        ...
        protected void del_Wallet(object sender, EventArgs e)
        {
            if (Request["delbox"] != null)
            {
                try
                {
                    ...
                    commonTool.Show_Have_Url(lt_result, "删除成功！", "Wallet.aspx", 0);
                }
                catch (Exception ex)
                {
            ...
            {
                commonTool.Show_Have_Url(lt_result, "请选择要删除数据！", "", 1);
            }
        }
    }
}