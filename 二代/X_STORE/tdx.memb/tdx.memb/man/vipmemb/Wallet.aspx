<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wallet.aspx.cs" Inherits="tdx.memb.man.vipmemb.Wallet" %>
    ...
    <div class="nei_content" id="nei_content">
     <div class="greenRemind">
        ...
        <div class="btn_container">
            <input type="button" class="btnAdd" onclick="location.href='WalletEdit.aspx'" value="添加钱包规则" />
            <input name="delBtn" value="彻底删除" onclick="return confirm('确定删除吗？删除后将不可恢复！');" runat="server"
                id="delBtn" class="btnDelete" type="submit" onserverclick="del_Wallet" />
        </div>
        <div class="tdh">
