...
{
    public partial class Action_Now : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string sql = string.Format(" ac_bdate<='{0}' and ac_edate>='{1}'", DateTime.Now.ToString(), DateTime.Now.ToString()); //wid={0} and wid, 
