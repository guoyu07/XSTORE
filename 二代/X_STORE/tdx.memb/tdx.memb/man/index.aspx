<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="tdx.memb.admin.index" %>
...
//预览
                ...
                b = a[0].innerHTML.replace("<span>", "");
                b = b.replace("</span>", "");

                if (b == "预览") {
                    window.open('/shop/index2.aspx?WHC=1', '', 'height=543,width=376,scrollbars=yes,status=yes');
