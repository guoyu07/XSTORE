<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_Dclass_List.aspx.cs" Inherits="tdx.memb.man.Texts.B2C_Dclass_List" %>
                    ...
                    <table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
                        <tr>
                            <td width="80%" align="left" height="40"  class='borderBottom'><input type="checkbox" class="btn"  name="delAll" id="delAll" runat="server" onclick ="this.value=checkAll(form1.delbox,this);" />全部&nbsp;
                               <asp:Button  ID="delBtn" runat="server" Text="彻底删除" class="btnGray" ForeColor="Red" OnClick="delBtn_ServerClick" OnClientClick="return confirm('确定删除吗？删除后将不可恢复！')" />
                             </td>
