<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_Honor_List.aspx.cs" Inherits="tdx.memb.man.Texts.B2C_Honor_List" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="nei_content">
            ...
            <div class="btn_container">
                ...
                <asp:Button ID="delBtn" runat="server" Text="彻底删除" CssClass="btnDelete"
                    OnClientClick="return confirm('确定删除吗？删除后将不可恢复！')" OnClick="delBtn_Click" />
            </div>
