<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vote_Album_list.aspx.cs" Inherits="tdx.memb.man.Texts.vote_Album_list" %>
...
<body>
    ...
    <div class="nei_content">
        ...
        <!--搜索-->
        <div class="nei_seach">
            关键词：<input type="text" placeholder="请输入投票项目或者投票名进行搜索" value="" name="ss_keyword"
                id="ss_keyword" runat="server" class="px" />
