    ...
    try {
        ...
        if (jsonstr.status == '1') {
            ...
            if (this.customSettings.button_action == SWFUpload.BUTTON_ACTION.SELECT_FILE) {
                ...
                $(this.customSettings.upload_target).siblings("img.upload-img").attr("src", jsonstr.path);
            } else {
        ...
        if (jsonstr.status == '2') {
            ...
            if (str != "") {
                ...
                $(this.customSettings.upload_target).siblings("img.upload-img").attr("src", jsonstr.list[0]);
