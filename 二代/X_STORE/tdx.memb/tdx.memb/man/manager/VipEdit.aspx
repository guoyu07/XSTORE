<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VipEdit.aspx.cs" Inherits="tdx.memb.man.manager.VipEdit" %>
...
<body  class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">用户修改
                            </a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>登陆密码</dt>&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="password" runat="server" CssClass="input normal" TextMode="Password" datatype="*1-100" sucmsg=" "  nullmsg="请输入密码"></asp:TextBox>
                <span class="Validform_checktip">*必填</span>
            </dl>
            <dl>
                <dt>确认密码</dt>&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <!--工具栏-->
         <br/>
            ...
            <div class="btn-list">
                <asp:Button ID="btnSubmit" runat="server" Text="提交保存" CssClass="btn" OnClick="btnSubmit_Click2" />
