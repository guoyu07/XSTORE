...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advert_operateTalkLunBo.aspx.cs" Inherits="tdx.memb.man.Talking.advert_operateTalkLunBo" %>
...
<%--                                <asp:TextBox ID="url" runat="server" CssClass="input normal" Text='<%#Eval("url") %>' placeholder="请选择关联帖子" />
