<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_ADS_List3.aspx.cs" Inherits="tdx.memb.man.Ads.B2C_ADS_List3" %>
 ...
 <form  id="form1" runat="server"  >    
            ...
            <div class="nei_content">
             ...
             <table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                <td width="20%"  align="left"  class='borderBottom'><asp:Label ID="lb_cateadd" runat ="server" > </asp:Label></td>
