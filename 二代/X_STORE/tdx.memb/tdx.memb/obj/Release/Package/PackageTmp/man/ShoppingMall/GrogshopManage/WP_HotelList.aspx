<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WP_HotelList.aspx.cs" Inherits="tdx.memb.man.ShoppingMall.GrogshopManage.WP_HotelList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap" style="padding: 10px 0 10px 0;">
            <div class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                         <div style="display: block; overflow:hidden;margin-bottom:10px;">
                            ...
                            <li><a class="add" href="WP_HotelAdd.aspx"><i></i><span>新增</span></a></li>
                            <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
                            <li>
                                <asp:LinkButton ID="btnDelete" runat="server" CssClass="del" 
                                    OnClientClick="return ExePostBack('btnDelete','您将删除集团、酒店和房间相关的数据<br/>确认删除吗？');" 
        ...
        <table style="width:100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
            <tr>
                ...
                <th style="width:15%">酒店全称/简称</th>
                <th style="width:15%">Logo</th>
               <th style="width:10%">区域</th>
                <th style="width:15%">总数</th>
                <th style="width:15%">总额</th>
            ...
            <asp:Repeater ID="Rp_hotelInfo" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a class="add" href="WP_HotelEdit.aspx?id=<%#Eval("id")%>">修改</a>
                        </td>
                </ItemTemplate>
                <FooterTemplate>
                    <%#Rp_hotelInfo.Items.Count == 0 ? "<tr><td align='center' colspan='6'>暂无记录</td></tr>" : ""%>
                </FooterTemplate>
            </asp:Repeater>
        </table>
