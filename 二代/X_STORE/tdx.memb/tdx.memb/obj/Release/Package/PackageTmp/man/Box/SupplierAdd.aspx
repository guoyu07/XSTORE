<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierAdd.aspx.cs" Inherits="tdx.memb.man.Box.SupplierAdd" %>
            ...
            <dl>
                ...
                <dd>
                    <asp:TextBox ID="txt_phono" runat="server" placeholder="电话" CssClass="input normal"
                        datatype="*0-100" sucmsg=" " />
                    <span class="Validform_checktip">*必填 格式:0150-1111111</span>
                </dd>
            </dl>
            <dl>
                <dt>邮编</dt>
               ...
               <dl>
                <dt>电子邮件</dt>
                <dd>
                    <asp:TextBox ID="txt_email" runat="server" placeholder="电子邮件" CssClass="input normal"
                        datatype="*0-100" sucmsg=" " />
                    <span class="Validform_checktip">*必填 格式:xxx@163.com</span>
                </dd>
            </dl>
               <dl>
                <dt>网址</dt>
                <dd>
                    <asp:TextBox ID="txt_www" runat="server" placeholder="网址" CssClass="input normal"
                        datatype="*0-100" sucmsg=" " />
                    <span class="Validform_checktip">*必填 格式:http://www.baidu.com</span>
                </dd>
            </dl>
        </div>
