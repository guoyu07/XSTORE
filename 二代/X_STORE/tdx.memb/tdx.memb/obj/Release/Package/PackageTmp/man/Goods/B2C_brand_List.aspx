<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_brand_List.aspx.cs" Inherits="tdx.memb.man.Goods.B2C_brand_List" %>
     ...
     <div class="greenRemind">
        ...
        <div class="btn_container">
            ...
            <asp:Button ID="delBtn" runat="server" Text="彻底删除" class="btnDelete" 
                OnClick="delBtn_ServerClick" OnClientClick="return confirm('确定删除吗？删除后将不可恢复！')" /></div>
        <div class="tdh">
