<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelWarehouseBoxEdit.aspx.cs" Inherits="tdx.memb.man.HotelWarehouse.HotelWarehouseBoxEdit" %>
 ...
 <!--导航栏-->
        ...
        <div class="tab-content">
            <dl>
                <dt>选择省</dt>
                <dd>
                    <asp:DropDownList CssClass="input" ID="ddl_shen" runat="server" AutoPostBack="true"></asp:DropDownList>
                </dd>
            </dl>
           <%-- <dl>
                <dt>选择市</dt>
            ...
            <dl>
                <dt>酒店名</dt>
                <dd>
                    <asp:DropDownList CssClass="input" ID="ddl_warehouse" runat="server" AutoPostBack="true" ></asp:DropDownList>
                </dd>
            </dl>
            <dl>
                <dt>房间名</dt>
                <dd>
                    ...
                    <span class="gray">库位名称,不得为空,最长200字符</span>
