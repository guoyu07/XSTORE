<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advert_manageTalk.aspx.cs" Inherits="tdx.memb.man.Talking.advert_manageTalk" %>
  ...
  <div id="floatHead" class="toolbar">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td>
           <a href="advert_operateTalk.aspx?ID=<%#Eval("id")%>&Act=Edit">修改</a><iframe name='ajax' style="display:none"></iframe>
        </td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
