<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_Hclass_Add.aspx.cs" Inherits="tdx.memb.man.Texts.B2C_Hclass_Add" %>
    ...
    <div class="greenRemind">
        ...
        <table class="enter_table">
            ...
            <tr>
                ...
                <td class="enter_content">
                    <input id="txtgif" type="file" class="px" runat="server" maxlength="300" onchange="Preview()"
                     /><br />
            ...
            <tr>
                ...
                <td class="enter_content">
                    <input type="text" placeholder="排序规则,必须为数字，默认为99" name="txtpx" class="px" runat="server"
                        id="txtpx" /><br />
            ...
            <tr>
                ...
                <td class="enter_content">
                    ...
                    <span class="gray">描述信息，最多150字</span><br />
                    <br />
                </td>
            </tr>
            <tr>
