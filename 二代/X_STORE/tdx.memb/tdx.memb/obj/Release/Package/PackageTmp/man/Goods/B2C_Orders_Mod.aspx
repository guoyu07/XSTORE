<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_Orders_Mod.aspx.cs" Inherits="tdx.memb.man.Goods.B2C_Orders_Mod" %>
    ...
    <div class="nei_content" id="nei_content">
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtConsignee" placeholder="收货人名字" class="px" runat="server"
                        id="txtConsignee" />
                </td>
                <td width="10%" style="height: 24px">
                </td>
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtTelephone" placeholder="收货人电话信息" class="px" runat="server"
                        id="txtTelephone" />
                </td>
                <td width="10%" style="height: 24px">
                    &nbsp;
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtMobile" placeholder="收货人手机信息" class="px" runat="server"
                        id="txtMobile" />
                </td>
                <td width="10%" style="height: 24px">
                    &nbsp;
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtSname" placeholder="订单金额,必须为大于1的数字" class="px" runat="server"
                        id="txtAmtOld" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtYF" placeholder="运费,必须为大于1的数字" runat="server" id="txtYF"
                        class="px" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtAmt" placeholder="订单总金额,必须为大于1的数字" runat="server" id="txtAmt"
                        class="px" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtCent" placeholder="赠送总积分,必须为大于1的数字" runat="server" id="txtCent"
                        class="px" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtSendDate" placeholder="配送时间" runat="server" id="txtSendDate"
                        class="px" />
                </td>
                <td width="10%" style="height: 24px">
                    &nbsp;
