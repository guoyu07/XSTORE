<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_Goods_List.aspx.cs" Inherits="tdx.memb.man.Goods.B2C_Goods_List" %>
    ...
    <div class="nei_content">
      ...
      <div class="greenRemind">
        ...
        <div class="nei_seach">
            ...
            <select name="ss_cid" id="ss_bid" runat="server" class="select-field_sousuo">
