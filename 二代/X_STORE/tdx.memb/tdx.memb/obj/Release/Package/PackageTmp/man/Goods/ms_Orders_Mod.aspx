<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ms_Orders_Mod.aspx.cs" Inherits="tdx.memb.man.Goods.ms_Orders_Mod" %>
    ...
    <div class="nei_content" id="nei_content">
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtConsignee" placeholder="收货人" class="px" runat="server"
                        id="txtConsignee" />
                </td>
                <td width="10%" style="height: 24px">
                </td>
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtYF" placeholder="快递运费,必须为大于0的数字" runat="server" id="txtYF"
                        class="px" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtAmt" placeholder="赠送的总金额,必须为大于0的数字" runat="server" id="txtAmt"
                        class="px" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtCent" placeholder="赠送的总积分,必须为大于0的数字" runat="server" id="txtCent"
                        class="px" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <textarea id="txtRemarks" runat="server" placeholder="秒杀订单备注信息" cols="20" rows="5"
                        class="px2"></textarea>
                </td>
                <td width="10%" style="height: 24px">
                    &nbsp;
