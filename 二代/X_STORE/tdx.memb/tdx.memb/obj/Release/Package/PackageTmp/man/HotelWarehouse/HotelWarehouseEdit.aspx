<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelWarehouseEdit.aspx.cs" Inherits="tdx.memb.man.HotelWarehouse.HotelWarehouseEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="page-footer">
            <div class="btn-list">
                ...
                <input name="btnReturn" type="button" value="返回上一页" class="btn yellow" onclick="javascript: window.location.href = 'HotelWarehouseList.aspx'" />
            </div>
        </div>
    </form>
</body>
