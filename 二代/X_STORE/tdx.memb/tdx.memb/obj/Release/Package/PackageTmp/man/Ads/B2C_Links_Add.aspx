<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_Links_Add.aspx.cs" Inherits="tdx.memb.man.Ads.B2C_Links_Add" %>
...
<body>  
 ...
 <form  id="form1" runat="server"  >          
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" >    
                <tr> 
                    <td width="20%" align="center" height="40"> 友链名称</td>
                    <td width="60%"><input type=text name="txtname" value="" runat="server" id="txtname"  class="px"  placeHolder="请输入友链名称"/><asp:RequiredFieldValidator 
                ...
                <tr> 
                    ...
                    <td width="60%">
                    <input id="fileimg" type="file" size="30"  runat="server" class="px"  /><span class="Notes"> 大小：230*78</span><br />
                    <asp:Image ID="Image1" runat="server" Width="100" Height="100" />
                      </td>
                    <td> </td>  
                </tr> 
                <tr>  
                    <td width="20%" align="center" height="40">  友链url</td>
                    <td width="60%">
