<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExChangeGoods.aspx.cs" Inherits="tdx.memb.man.Box.ExChangeGoods" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function open_dialog(sender) {
            ...
            var boxid = obj.attr("box_id");//箱子id
            var show = $.dialog({
                id: 'suibian',
                lock: true,
                min: false,
                title: "",
                content: 'url:/man/Box/ApplicationManage.aspx?id=' + id + '&lx=1',//只能用绝对路径
                width: w,
                height: h
        ...
        <div class="toolbar-wrap">
            ...
            <div class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li>&nbsp;&nbsp;
                            <span style="font-size: 12px;">库位名</span>&nbsp;<asp:TextBox ID="kw_name" runat="server" CssClass="input"
                        ...
                        <li>&nbsp;&nbsp;<span style="font-size: 12px;">状态</span>
                            <asp:DropDownList CssClass="input" ID="zt_lx" runat="server" AutoPostBack="true">
                                ...
                                <asp:ListItem Value="1">换货申请中</asp:ListItem>
            ...
            <telerik:RadAjaxPanel runat="server">
                <table width=" 100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    ...
                    <asp:Repeater ID="Rp_changeGoods" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td style="text-align: center;"><%#Eval("库位名")%>
                                    <asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" />
                                </td>
                                <td style="text-align: center;"><%#Eval("原商品品名")%></td>
                                <td style="text-align: center;"><%#Eval("新商品品名")%></td>
