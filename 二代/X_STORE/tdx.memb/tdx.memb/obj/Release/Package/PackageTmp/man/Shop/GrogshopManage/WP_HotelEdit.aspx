<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WP_HotelEdit.aspx.cs" Inherits="tdx.memb.man.Shop.GrogshopManage.WP_HotelEdit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="../../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>用户信息</span> <i class="arrow"></i><span>用户信息修改</span>
        </div>
        <div class="line10">
        </div>
