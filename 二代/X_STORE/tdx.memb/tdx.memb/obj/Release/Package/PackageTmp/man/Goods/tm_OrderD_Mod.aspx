<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tm_OrderD_Mod.aspx.cs" Inherits="tdx.memb.man.Goods.tm_OrderD_Mod" %>
    ...
    <div class="nei_content" id="nei_content">
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtQnt" placeholder="团购商品数量,必须为大于0的数字" class="px" runat="server"
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtPrice" placeholder="团购价格,必须为大于0的数字" class="px" runat="server"
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtAmt" placeholder="团购金额,必须为大于0的数字" class="px" runat="server"
                        id="txtAmt" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtCent" placeholder="赠送积分,必须为大于0的数字" class="px" runat="server"
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <input type="text" name="txtAllAmt" placeholder="赠送总积分,必须为大于0的数字" class="px" runat="server"
                        id="txtAllAmt" />
            ...
            <tr>
                ...
                <td style="width: 70%; height: 24px;">
                    <textarea id="txtRemarks" runat="server" placeholder="团购备注信息" cols="20" rows="5"
                        class="px2"></textarea>
                </td>
                <td width="10%" style="height: 24px">
                    &nbsp;
