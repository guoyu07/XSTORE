<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_attach1.aspx.cs" Inherits="smartHotel.Meal.Meal.dialog.dialog_attach1" %>
...
<head runat="server">
    ...
    <script src="../js/lhgdialog.js?skin=idialog""></script>
    ...
    <script type="text/javascript">
        ...
        //页面加载完成执行
        $(function () {
            //        $(".upload-attach").InitSWFUpload({ filesize: "20480", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;*.rar;*.zip;*.doc;*.xls;*.pdf" });
            $(".upload-attach").InitSWFUpload({ filesize: "51200", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../js/swfupload/swfupload.swf", filetypes: "*.*" });
        ...
        function appendAttachHtml(fileName, filePath, fileExt, fileSize, fileSizeStr) {
            if ($(api.data).length > 0) {
                ...
                + '<div class="title"><a href="' + filePath + '">' + fileName + '</a></div>'
