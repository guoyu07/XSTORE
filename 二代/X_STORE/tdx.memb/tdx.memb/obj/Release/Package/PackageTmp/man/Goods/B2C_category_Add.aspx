<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_category_Add.aspx.cs" Inherits="tdx.memb.man.Goods.B2C_category_Add" %>
            ...
            <tr>
                ...
                <td class="enter_content">
                    <input type="text" name="txtmc" placeholder="产品类别名称,不得为空" class="px" runat="server"
                        ...
                        <span class="gray">产品类别名称,不得为空,最长200字符</span><br />                    
                </td>
                <td class="rb">*</td>
            </tr>
            <tr>
