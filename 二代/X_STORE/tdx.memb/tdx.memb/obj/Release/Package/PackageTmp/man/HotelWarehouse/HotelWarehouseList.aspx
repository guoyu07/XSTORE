<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelWarehouseList.aspx.cs" Inherits="tdx.memb.man.HotelWarehouse.HotelWarehouseList" %>
        ...
        <script type="text/javascript">
            function open_dialog(sender) {
                ...
                var show = $.dialog({
                    ...
                    min: false,
                    title: "",
                    content: 'url:/man/HotelWarehouse/HotelGoodsInventory.aspx?id=' + id,
                    width: w,
                    height: h
                ...
                show.window = window;
                //window.location.href = "HotelGoodsInventory.aspx";
            }
       ...
       <asp:ScriptManager runat="server"></asp:ScriptManager>
        ...
        <div class="toolbar-wrap">
            <div class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li>&nbsp;&nbsp;<span style="font-size: 14px;">酒店集团/酒店名</span>&nbsp;&nbsp;<input id="ckmjdm" runat="server" class="selected" />
                            &nbsp; &nbsp; <asp:LinkButton ID="LBtn_sousuo" runat="server" OnClick="LBtn_sousuo_Click"><span>搜索</span></asp:LinkButton>
                        </li>
                        <br />
                        <li><a class="add" href="HotelWarehouseAdd.aspx"><i></i><span>新增</span></a></li>
                        <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
                        <li>
                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="del" 
                                OnClientClick="return ExePostBack('btnDelete','您将删除酒店和房间相关的数据<br/>确认删除吗？');" 
                                OnClick="btnDelete_Click"><i></i><span>删除</span>
                            </asp:LinkButton>
                        </li>
                    </ul>
                </div>
            ...
            <table  style="width:100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                <tr>
                    ...
                    <th  style="width:12%">地区名称</th>
                    <th  style="width:12%">酒店集团</th>
                    <th  style="width:12%">酒店名称</th>
                    <th  style="width:12%">Logo</th>
                    <th  style="width:12%">前台电话</th>
                    <th  style="width:13%">地址</th>
                    <th  style="width:12%">操作</th>
                </tr>
                <asp:Repeater ID="Rp_hotelwarehouse" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align: center;"><img style="height:100px;width:100px;" src='<%#Eval("Logo")%>' /></td>
                            <td style="text-align: center;"><%#Eval("电话")%></td>
                             <td style="text-align: center;"><%#Eval("详细地址") %></td>
                            <td style="text-align: center;"><a href="HotelWarehouseEdit.aspx?id=<%#Eval("id")%>">修改</a><br/>
                                    <a href=" javascript:void(0);" onclick="open_dialog(this)" hotel-id='<%#Eval("id")%>' >商品库存</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
