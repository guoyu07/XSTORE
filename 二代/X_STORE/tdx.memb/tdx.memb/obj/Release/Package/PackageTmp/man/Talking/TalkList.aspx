<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalkList.aspx.cs" Inherits="tdx.memb.man.Talking.TalkList" %>
            ...
            <asp:Repeater ID="Rp_UserInfo" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align: center;"><%#Eval("类别号")%><br/><%#Eval("类别名")%></td>
                        <td style="text-align: center;"><%#Eval("创建时间")%></td>
                        <td style="text-align: center;"><%#Eval("发布人")%></td>
                        <td style="text-align: center;"><%#Eval("是否置顶").ToString()=="1"?"是":"否"%></td>
                        <td style="text-align: center;"><a href="TalkEdit.aspx?id=<%#Eval("id")%>">修改</a> </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
        </table>
