<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C_order_List.aspx.cs" Inherits="tdx.memb.man.Goods.B2C_order_List" %>
    ...
    <div class="nei_content">
     <div class="greenRemind">
        ...
        <div class="nei_seach">
            ...
            &nbsp;<input id="txt_StartCPXG" runat="server" cssclass="edLine" readonly="readonly" onfocus="HS_setDate(this)" placeholder="请输入起始时间，缺省从当月1号开始"
                class="sousuo_px" type="text" />
            &nbsp;
            <input id="txt_StartCPXG_DATE" runat="server" cssclass="edLine" readonly="readonly" onfocus="HS_setDate(this)" placeholder="请输入截止时间，缺省截止到当天"
                class="sousuo_px" type="text" />
            &nbsp;
            ...
            <asp:Button ID="ss_btn" runat="server" OnClick="ss_btn_Click" Text="搜索" CssClass="btnGray" />
        </div>
