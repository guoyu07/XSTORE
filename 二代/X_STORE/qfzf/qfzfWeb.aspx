<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qfzfWeb.aspx.cs" Inherits="qfzfUI.qfzfWeb" %>
    ...
    <form id="form1" runat="server">
        <div style="text-align: center; width: 100%;">
            ...
            <table style="margin-left: auto; margin-right: auto; margin-top: 50px;">
                ...
                <tr>
                    <td height="50">
                        <asp:Button ID="btn_product" runat="server" CssClass="pagego" Text="生成列表页" OnClick="btn_product_Click" /></td>
                </tr>
                <tr>
                    <td height="50"></td>
                </tr>
