...
namespace Com.Alipay
{
    ...
    public class Config
    {
        ...
        static Config()
        {
            ...
            partner = "2088002942502152";

            //交易安全检验码，由数字和字母组成的32位字符串
            key = "31m2ifh8ug6d9bundk3lhu3wex21bfui";

            //签约支付宝账号或卖家支付宝帐户
            seller_email = "578399552@qq.com";

            //页面跳转同步返回页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            return_url = "http://www.tdx.cn/agent/alipay_return.aspx";

            //服务器通知的页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            notify_url = "http://www.tdx.cn/agent/alipay_notify.aspx";
