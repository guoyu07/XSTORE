...
{
    /// <summary>
    /// readyToChangeRooms 的摘要说明
    /// </summary>
    public class readyToChangeRooms : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    string sql_apply = "select id as value, 库位名 as text from wp_库位表 where 仓库id='" + dt_hotel.Rows[0]["仓库id"].ToString() + "' and 箱子mac is null and 库位名 not like '%总台%' and isshow=1";
