<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="operateReport.aspx.cs" Inherits="Wx_NewWeb.Shop.pages.operateReport" %>
            ...
            <div id="content1" class="mui-control-content mui-active">
                ...
                <div class="ReportInputContaienr">
                    <div class="selectBeginTime">
                        <p>选择开始时间</p>
                        <input placeholder="选择开始时间" type="date" id="start_time" runat="server" />
                    </div>
                    <div class="line">
                        <span>&mdash;</span>
                    </div>
                    <div class="selectEndTime">
                        <p>选择结束时间</p>
                        <input placeholder="选择结束时间" type="date" id="end_time" runat="server"/>
                    </div>
<%--<asp:Button runat="server" OnClick="search_Click" class="search"  ID="search" text="搜索" />--%>
                </div>
