<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GeneralManagerFooter.ascx.cs" Inherits="Wx_NewWeb.Shop.ascx.GeneralManagerFooter" %>
<!--总经理-->
<!--酒店经理-->
<nav id="foot">
    <ul class="clearfix">
        <li>
            <a href="../OperateManager/home.aspx">
                <div class="index_bot">
        ...
        <li>
            <a href="../OperateManager/hotelList.aspx">
                <div class="index_bot">
        ...
        <li>
            <a href="../pages/operateReport.aspx">
                <div class="index_bot">
