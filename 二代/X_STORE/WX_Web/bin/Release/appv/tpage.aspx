<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tpage.aspx.cs" Inherits="jnsywx.appv.tpage" %>
...
<body class="nei_body">
    ...
    <div class="d_body">
        <div class="d_content">
            ...
            <h5>
                <span id="proAuthor">
                    <asp:Literal ID="lt_proAuthor" runat="server" EnableViewState="false"></asp:Literal></span>
                <span id="proDate">
                    <asp:Literal ID="lt_proDate" runat="server" EnableViewState="false"></asp:Literal></span>
            </h5>
    ...
    <div class="d_share">
        ...
        <ul>
            ...
            <li>
                <asp:Literal ID="lt_tel" runat="server"></asp:Literal></li>
