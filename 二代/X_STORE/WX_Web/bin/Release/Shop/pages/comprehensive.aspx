<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comprehensive.aspx.cs" Inherits="Wx_NewWeb.Shop.pages.comprehensive" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="main" style="-webkit-overflow-scrolling: touch;">
            ...
            <div class="user item">
                ...
                <ul>
                    <asp:Repeater ID="user_item_rp" runat="server" OnItemDataBound="user_item_rp_ItemDataBound">
                        <ItemTemplate>
                            <li>
                                <div class="clearfix newStrip">
                                    <h3 class="l over"><%# Eval("仓库名") %></h3>
                                    <div class="iconfont icon-gengduo1 r iconChange"></div>
                                    <div class="iconfont icon-gengduo2 r iconChange"></div>
                                    <p class="r"><span><%#Eval("人数") %></span>人</p>
                                    <asp:HiddenField ID="hfid" runat="server" Value='<%# Eval("仓库id") %>' />
                                    <%--   <span id="hotel_id" runat="server" style="display:none"><%# Eval("仓库id") %></span>--%>
                                </div>
                                <dl class="content">
                                    <asp:Repeater ID="child_user_item_rp" runat="server">
                                        <ItemTemplate>
                                            <dd class="clearfix">
                                                <h3 class="l">酒店<%#Eval("角色类型") %></h3>
                                                <p class="r"><%#Eval("真实姓名") %></p>
                                            </dd>
                                        </ItemTemplate>
                                    </asp:Repeater>
