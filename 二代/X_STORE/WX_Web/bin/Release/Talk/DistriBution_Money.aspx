<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistriBution_Money.aspx.cs" Inherits="Wx_NewWeb.Talk.DistriBution_Money" %>
...
<body>
    <form runat="server">
                      ...
                      <ItemTemplate>
            	            <li>
                                ...
                                <div class="t_yj clear">
                                    ...
                                    <div class="fr"><span>佣金：</span><span class="price"><em>¥</em><span id="totalmoney"><%#Eval("acmoney")%></span></span></div>
                                </div>
                                <div class="yj_con"><%#Eval("ac_des")%></div>
                            </li>
                       </ItemTemplate>
                  </asp:Repeater>
            </ul>
        ...
        <!--正文列表结束-->
        <div class="more bot_80"><a id="loadmore" href="#" onclick="loadmore()">加载更多</a></div>
        <!--正文结束-->
