        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(Request.QueryString["code"]))
                {
                    ...
                    OAuth_Token oauth = _wx.Get_token(Code);
                    ...
                    //WWV  微信关注OpenID,WWX微信ID
                    string WWV = oauth.openid != null ? oauth.openid.Trim() : "";
                    ...
                    if (Convert.ToInt32(dt_log_num.Rows[0][0]) < Convert.ToInt32(dt.Rows[0]["ac_men_num"])) //小于3才可以玩
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            //lt_newsContent.Text = "<h1 class=\"t_title\">" + dt.Rows[0]["ac_title"].ToString().Trim() + "</h1><p  class=\"t_title2\">" + dt.Rows[0]["ac_des"].ToString().Trim() + "</p>";
                            lt_newsContent.Text = "<h1 class=\"t_title\">" + dt.Rows[0]["ac_title"].ToString().Trim() + "</h1>";
                            ...
                            lt_shuoming.Text = dt.Rows[0]["ac_des"].ToString().Trim();
                        }
                        else
                        {
                            lt_newsContent.Text = "<p class='serv_res'><span class='red'>没有设定活动ID</span></p>";
                ...
                else
                {
                    ...
                    //只获取OpenID
                    string URL = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + _wx.devlopID + "&redirect_uri=" + RedirectUri + "&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect";
