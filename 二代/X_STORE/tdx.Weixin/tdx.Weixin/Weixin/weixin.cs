...
namespace tdx.Weixin
{
    public class weixin
    {
        ...
        /// <returns></returns>
        public weixinUser GetWebUserInfo(string OAuthToken, string _openid)
        {
            string _result = string.Empty;
            string url_WebUserInfo_Create = "https://api.weixin.qq.com/sns/userinfo?access_token=" + OAuthToken + "&openid=" + _openid + "&lang=zh_CN";

            _result = func.webRequestGet(url_WebUserInfo_Create);
            try
            {
