...
namespace DTcms.DAL
{
	...
	public partial class B2C_tclass
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("c_id", "B2C_tclass"); 
		}
		...
		public bool Exists(int c_id)
		{
			...
			strSql.Append("select count(1) from B2C_tclass");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DTcms.Model.B2C_tclass model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into B2C_tclass(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DTcms.Model.B2C_tclass model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update B2C_tclass set ");
		...
		public bool Delete(int c_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from B2C_tclass ");
			strSql.Append(" where c_id=@c_id");
			SqlParameter[] parameters = {
					new SqlParameter("@c_id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.B2C_tclass GetModel(int c_id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 c_id,c_no,c_name,c_gif,c_url,c_sort,c_des,c_isactive,c_isdel,regtime,c_parent,c_level,c_child from B2C_tclass ");
			strSql.Append(" where c_id=@c_id");
			SqlParameter[] parameters = {
					new SqlParameter("@c_id", SqlDbType.Int,4)
			};
			...
			DTcms.Model.B2C_tclass model=new DTcms.Model.B2C_tclass();
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.B2C_tclass DataRowToModel(DataRow row)
		{
			DTcms.Model.B2C_tclass model=new DTcms.Model.B2C_tclass();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from B2C_tclass T ");
