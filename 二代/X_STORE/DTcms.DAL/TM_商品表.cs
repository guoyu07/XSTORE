...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2016-04-18 14:51:26   N/A    初版
*
...
namespace DTcms.DAL
{
	...
	public partial class TM_商品表
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "TM_商品表"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from TM_商品表");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DTcms.Model.TM_商品表 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TM_商品表(");
			strSql.Append("用户ID,编号,编号new,类别号,品名,规格,单位,重量,序号,市场价,本站价,三团价,九团价,上架时间,下架时间,录入时间,库存数量,限购数量,分销率,IsShow,是否上架,类型,critical_value,isTuan,折扣率,是否卖家承担运费,满多少包邮,运费模板)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@isTuan", SqlDbType.TinyInt,1),
			...
			parameters[23].Value = model.isTuan;
			parameters[24].Value = model.折扣率;
			parameters[25].Value = model.是否卖家承担运费;
			parameters[26].Value = model.满多少包邮;
			parameters[27].Value = model.运费模板;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DTcms.Model.TM_商品表 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TM_商品表 set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TM_商品表 ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.TM_商品表 GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,用户ID,编号,编号new,类别号,品名,规格,单位,重量,序号,市场价,本站价,三团价,九团价,上架时间,下架时间,录入时间,库存数量,限购数量,分销率,IsShow,是否上架,类型,critical_value,isTuan,折扣率,是否卖家承担运费,满多少包邮,运费模板 from TM_商品表 ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			DTcms.Model.TM_商品表 model=new DTcms.Model.TM_商品表();
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.TM_商品表 DataRowToModel(DataRow row)
		{
			DTcms.Model.TM_商品表 model=new DTcms.Model.TM_商品表();
			if (row != null)
			{
				...
				if(row["isTuan"]!=null && row["isTuan"].ToString()!="")
				{
					model.isTuan=int.Parse(row["isTuan"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,用户ID,编号,编号new,类别号,品名,规格,单位,重量,序号,市场价,本站价,三团价,九团价,上架时间,下架时间,录入时间,库存数量,限购数量,分销率,IsShow,是否上架,类型,critical_value,isTuan,折扣率,是否卖家承担运费,满多少包邮,运费模板 ");
			strSql.Append(" FROM TM_商品表 ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,用户ID,编号,编号new,类别号,品名,规格,单位,重量,序号,市场价,本站价,三团价,九团价,上架时间,下架时间,录入时间,库存数量,限购数量,分销率,IsShow,是否上架,类型,critical_value,isTuan,折扣率,是否卖家承担运费,满多少包邮,运费模板 ");
			strSql.Append(" FROM TM_商品表 ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TM_商品表 T ");
