...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2016-04-13 16:41:38   N/A    初版
*
...
namespace DTcms.DAL
{
	...
	public partial class TM_订单子表
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "TM_订单子表"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from TM_订单子表");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DTcms.Model.TM_订单子表 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TM_订单子表(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DTcms.Model.TM_订单子表 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TM_订单子表 set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TM_订单子表 ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.TM_订单子表 GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,商品id,订单编号,价格,数量,推荐人openid,推荐人订单号,备注 from TM_订单子表 ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			DTcms.Model.TM_订单子表 model=new DTcms.Model.TM_订单子表();
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.TM_订单子表 DataRowToModel(DataRow row)
		{
			DTcms.Model.TM_订单子表 model=new DTcms.Model.TM_订单子表();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TM_订单子表 T ");
