...
namespace DTcms.DAL
{
	...
	public partial class WP_category
	{
		...
		public bool Exists(int c_id)
		{
			...
			strSql.Append("select count(1) from WP_category");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WP_category set ");
		...
		public bool Delete(int c_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WP_category ");
			strSql.Append(" where c_id=@c_id");
			SqlParameter[] parameters = {
					new SqlParameter("@c_id", SqlDbType.Int,4)
			};
		...
		public DTcms.Model.WP_category GetModel(int c_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 c_id,c_no,c_name,c_gif,c_url,c_sort,c_des,c_isactive,c_isdel,regtime,c_parent,c_level,c_child from WP_category ");
			strSql.Append(" where c_id=@c_id");
			SqlParameter[] parameters = {
					new SqlParameter("@c_id", SqlDbType.Int,4)
			};
			...
			DTcms.Model.WP_category model=new DTcms.Model.WP_category();
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.WP_category DataRowToModel(DataRow row)
		{
			DTcms.Model.WP_category model=new DTcms.Model.WP_category();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM WP_category ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WP_category T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WP_category";
