...
namespace DTcms.DAL
{
	...
	public partial class TM_购物车
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "TM_购物车"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from TM_购物车");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DTcms.Model.TM_购物车 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TM_购物车(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DTcms.Model.TM_购物车 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TM_购物车 set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TM_购物车 ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.TM_购物车 GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,openid,商品id,单价,数量,是否结算 from TM_购物车 ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			DTcms.Model.TM_购物车 model=new DTcms.Model.TM_购物车();
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.TM_购物车 DataRowToModel(DataRow row)
		{
			DTcms.Model.TM_购物车 model=new DTcms.Model.TM_购物车();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TM_购物车 T ");
