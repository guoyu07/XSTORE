...
namespace DTcms.DAL
{
	...
	public partial class WP_商品详情表
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "WP_商品详情表"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from WP_商品详情表");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DTcms.Model.WP_商品详情表 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WP_商品详情表(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DTcms.Model.WP_商品详情表 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WP_商品详情表 set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WP_商品详情表 ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.WP_商品详情表 GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,商品编号,描述,特点,注意事项,资质证明,品牌介绍 from WP_商品详情表 ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			DTcms.Model.WP_商品详情表 model=new DTcms.Model.WP_商品详情表();
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.WP_商品详情表 DataRowToModel(DataRow row)
		{
			DTcms.Model.WP_商品详情表 model=new DTcms.Model.WP_商品详情表();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WP_商品详情表 T ");
