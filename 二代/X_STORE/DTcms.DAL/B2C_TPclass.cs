...
namespace DTcms.DAL
{ 
	public partial class B2C_TPclass
	{
		public B2C_TPclass()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("c_id", "B2C_TPclass"); 
		}
		...
		public bool Exists(int c_id)
		{
			...
			strSql.Append("select count(1) from B2C_TPclass");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DTcms.Model.B2C_TPclass model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into B2C_TPclass(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DTcms.Model.B2C_TPclass model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update B2C_TPclass set ");
		...
		public bool Delete(int c_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from B2C_TPclass ");
			strSql.Append(" where c_id=@c_id");
			SqlParameter[] parameters = {
					new SqlParameter("@c_id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.B2C_TPclass GetModel(int c_id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 c_id,c_no,c_name,c_gif,c_url,c_sort,c_des,c_isactive,c_isdel,regtime,c_parent,c_level,c_child from B2C_TPclass ");
			strSql.Append(" where c_id=@c_id");
			SqlParameter[] parameters = {
					new SqlParameter("@c_id", SqlDbType.Int,4)
			};
			...
			DTcms.Model.B2C_TPclass model=new DTcms.Model.B2C_TPclass();
		...
		/// 得到一个对象实体
		/// </summary>
		public DTcms.Model.B2C_TPclass DataRowToModel(DataRow row)
		{
			DTcms.Model.B2C_TPclass model=new DTcms.Model.B2C_TPclass();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM B2C_TPclass ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from B2C_TPclass T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "B2C_TPclass";
