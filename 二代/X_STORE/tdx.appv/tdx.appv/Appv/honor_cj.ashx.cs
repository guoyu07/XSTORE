...
namespace tdx.appv
{
    public class honor_cj : IHttpHandler, IRequiresSessionState
    {
        ...
        private void zhuanpan(HttpContext context, string add)
        {
            ...
            int count = Convert.ToInt32(dt_action.Rows[0]["ac_men_num"]) * Convert.ToInt32(dt_action.Rows[0]["ac_totlenum"]);
            int prizeno1 = Convert.ToInt32(dt_action.Rows[0]["ac_jp_one_num"]);
            int prizeno2 = Convert.ToInt32(dt_action.Rows[0]["ac_jp_two_num"]);
            int prizeno3 = Convert.ToInt32(dt_action.Rows[0]["ac_jp_three_num"]);
