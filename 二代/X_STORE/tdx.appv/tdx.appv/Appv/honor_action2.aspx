<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="honor_action2.aspx.cs"
    Inherits="tdx.appv.honor_action2" %>
...
<body class="nei_body">
    ...
    <div class="Appcontent">
        ...
        <p>
            ...
            <script type="text/javascript" src="/Appv/honoraction/images2/wScratchPad.js"></script>
            <div id="mainpan" runat="Server" class="main">
                <div class="cover">
                    <img src="/Appv/honoraction/images2/activity-scratch-card-bannerbg.png">
                    <div id="prize">
                    谢谢参与
                    </div>
                    <div id="scratchpad">
                ...
                <div class="content">
                    <div id="zjl" style="display: none" class="boxcontent boxwhite">
                        <div id="zjbox" class="box">
                            ...
                            <div class="Detail">
                                <p>
                                    你中了： <span id="prizetype" class="red"></span>
                                </p>
                            </div>
                            <p>
