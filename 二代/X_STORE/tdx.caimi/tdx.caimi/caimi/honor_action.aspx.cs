    ...
    public partial class honor_action : weixinAuth
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    lt_newsContent.Text = "<p class='serv_res'><span class='red'>您还没有抽奖机会。<a href='index.aspx?wwx=" + _tdxWeixinArry[3] + "&wwv=" + WWV + "&id=" + _ids + "'>请参加我们的猜谜活动，获得抽奖机会</a>。</span></p>";
                    mainpan.Visible = false;
                    return;
                }
                else
                {
                   //确认有机会抽奖
                    ...
                    lt_jp1.Text = "<p>【2014鼋头渚中秋赏月音乐烟花大会门票一张】</p>";
                    lt_shuoming.Text = "1）连续答对三道谜语，就有机会参加的转盘抽奖，赢取“2014鼋头渚中秋赏月水上音乐烟花大会”门票一张。";
                    lt_shuoming.Text += "    <br>";
                    lt_shuoming.Text += "2）抽中门票奖品的朋友，请分享至朋友圈；并于2014年9月6日或8日下午四点半后至鼋头渚景区充山大门领取门票。<br>";
                    lt_shuoming.Text += "3）每人每天只有三次机会。";
                }
