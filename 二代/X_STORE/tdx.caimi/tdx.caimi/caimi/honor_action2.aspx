<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="honor_action2.aspx.cs" Inherits="tdx.caimi.honor_action2" %>  
...
<head>
    ...
    <title>
        ...
        <script src="honoraction/honor2.js" type="text/javascript"></script>
</head>
<body class="nei_body">
        ...
        <p>
            ...
            <div id="mainpan" runat="Server" class="main">
                <div id="outercont">
                    <div id="outer-cont">
                        <div id="outer">
                            <img src="honoraction/images/activity-lottery-3.png" width="310px"></div>
                    </div>
                    <div id="inner-cont">
                        <div id="inner">
