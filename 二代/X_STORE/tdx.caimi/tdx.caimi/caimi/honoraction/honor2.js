...
$(function () {
    $("#save-btn").click(function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: "honor_cj2.ashx?action=tijiao",
            dataType: 'text',
...
$(function () {
        ...
        if (now < steps.length) {
            ...
            setTimeout(function () {
                if (prize != null) {
                    ...
                    $("#prizetype").text(type); //prizetype 中奖内容
                    $("#zjl").slideToggle(500); //中间外框
                    $("#outercont").slideUp(500) //转盘位置
                }
                else {
                    alert("谢谢您的参与，下次再接再厉")
                }
    ...
    $("#inner").click(function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: { "typeID": $("#h_acID").val(), "WWV": $("#h_WWV").val(), "guidno": $("#h_guidno").val(), t: Math.random() },
